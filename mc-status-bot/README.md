...
> Add your real Discord screenshots to `assets/screenshots/` and replace the filenames below.  
> The generated `assets/banner.png` above is a promotional README banner; the screenshots section should use real captures of your running bot.
...
<img src="assets/screenshots/java-status.png" alt="Minecraft Java server status in Discord" width="100%">
...
<img src="assets/screenshots/bedrock-status.png" alt="Minecraft Bedrock server status in Discord" width="100%">
...
<img src="assets/screenshots/auto-update.png" alt="Auto updating Minecraft server status panel" width="100%">
...
<img src="assets/screenshots/setup-status.png" alt="Discord setup status command" width="100%">
